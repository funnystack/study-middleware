...
public class CodeGenerator {
    ...
    public static void main(String[] args) {
        ...
        String url = "jdbc:mysql://127.0.0.1:3306/tools?useUnicode=true&characterEncoding=utf-8&useSSL=false&serverTimezone=UTC";
        String username = "root";
        String password = "root";
        String author = "fangli";
        String parentName = "com.funny.combo.tools";// 父包名
        String moduleName = "robot";// 父包模块名
        String tableName = "unit_robot,unit_robot_words";//表名，多个英文逗号分隔？所有输入 all
        AutoGenerator(url,
                username,
                password,
                author,
