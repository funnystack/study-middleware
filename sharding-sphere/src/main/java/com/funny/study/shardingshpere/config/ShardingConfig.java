package com.funny.study.shardingshpere.config;

import com.funny.study.shardingshpere.config.DatabaseShardingAlgorithm;
import com.funny.study.shardingshpere.config.TableRangeShardingAlgorithm;
import com.funny.study.shardingshpere.config.TableShardingAlgorithm;
...
@MapperScan(basePackages = "com.funny.study.shardingsphere.dao", sqlSessionTemplateRef = "shardSqlSessionTemplate")
